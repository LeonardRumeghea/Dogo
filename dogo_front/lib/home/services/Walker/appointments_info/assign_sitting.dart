...
class AssignSittingAppointmentPage extends StatefulWidget {
  const AssignSittingAppointmentPage(
  ...
  @override
  State<AssignSittingAppointmentPage> createState() => _Page();
}

class _Page extends State<AssignSittingAppointmentPage> {
  Pet _pet = Pet();
      ...
      child: SizedBox(
        ...
        child: Container(
          ...
          child: Padding(
            ...
            child: Row(
              children: [
                Icon(Icons.calendar_today, size: 26, color: Colors.indigo[400]),
                const Text(
                  ' To:',
                  style: TextStyle(
                    fontSize: 24,
                ...
                Text(
                  ' ${DateFormat('d MMM HH:mm').format(DateTime.parse(_appointment.dateUntil))}',
                  style: const TextStyle(fontSize: 22, color: Colors.white),
                ),
              ],
            ),
