...
class AssignSalonAppointmentPage extends StatefulWidget {
  const AssignSalonAppointmentPage(
  ...
  @override
  State<AssignSalonAppointmentPage> createState() => _Page();
}

class _Page extends State<AssignSalonAppointmentPage> {
  Pet _pet = Pet();
      ...
      child: SizedBox(
        ...
        child: Container(
          ...
          child: Padding(
            ...
            child: Row(
              children: [
                const Icon(Icons.timer, size: 26, color: Colors.green),
                const Text(
                  ' Duration:',
                  style: TextStyle(
                    fontSize: 24,
