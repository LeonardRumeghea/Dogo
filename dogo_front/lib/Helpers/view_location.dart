...
class PageLocationPicker extends StatefulWidget {
  const PageLocationPicker({Key? key, required this.address}) : super(key: key);
...
class _PageLocationPickerState extends State<PageLocationPicker> {
  ...
  getLication() async {
    var query =
        '${_address.state}, ${_address.city}, ${_address.street}, ${_address.zipCode}';
    var addresses = await geocoder.Geocoder.local.findAddressesFromQuery(query);

    var first = addresses.first;

    developer.log(first.coordinates.toString());
